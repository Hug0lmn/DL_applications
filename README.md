...
🔄 Encodeur-Decodeur character-level no attention model [Models]
🔄 Encodeur-Decodeur character-level light attention (Luong) model  
🔄 Decodeur only character-level model
